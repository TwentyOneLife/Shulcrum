...
public:
    ...
    /// Found by binary search over the stored headers -- the layout only ever switches once, at the
    /// fork's activation height -- and cached after the first call. Thread safe.
